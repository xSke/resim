...
class SaveCsv:
    ...
    def write(
        ...
        row = [
            ...
            batter_multiplier,
            runner_on_first.data["buoyancy"] if runner_on_first is not None else 0,
            runner_on_first.data["divinity"] if runner_on_first is not None else 0,
            runner_on_first.data["martyrdom"] if runner_on_first is not None else 0,
            runner_on_first.data["moxie"] if runner_on_first is not None else 0,
            runner_on_first.data["musclitude"] if runner_on_first is not None else 0,
            runner_on_first.data["patheticism"] if runner_on_first is not None else 0,
            runner_on_first.data["thwackability"] if runner_on_first is not None else 0,
            runner_on_first.data["tragicness"] if runner_on_first is not None else 0,
            runner_on_first.data["coldness"] if runner_on_first is not None else 0,
            runner_on_first.data["overpowerment"] if runner_on_first is not None else 0,
            runner_on_first.data["ruthlessness"] if runner_on_first is not None else 0,
            runner_on_first.data["shakespearianism"] if runner_on_first is not None else 0,
            runner_on_first.data["suppression"] if runner_on_first is not None else 0,
            runner_on_first.data["unthwackability"] if runner_on_first is not None else 0,
            ...
            runner_on_first.data["anticapitalism"] if runner_on_first is not None else 0,
            runner_on_first.data["chasiness"] if runner_on_first is not None else 0,
            runner_on_first.data["omniscience"] if runner_on_first is not None else 0,
            runner_on_first.data["tenaciousness"] if runner_on_first is not None else 0,
            runner_on_first.data["watchfulness"] if runner_on_first is not None else 0,
            runner_on_first.data["pressurization"] if runner_on_first is not None else 0,
            runner_on_first.data.get("cinnamon", 0) if runner_on_first is not None else 0,
            runner_on_first_multiplier,
